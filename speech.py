...
class speech():
    def __init__(self, root):
        ...
        textLabel = tk.Label(mainFrame, text="Enter your text: ", bg="sky blue", font=("Arial",20,"bold"))
        ...
        btn = tk.Button(mainFrame, bg="light gray",command=self.speak, width=20, text="Speech", font=("Arial", 20,"bold"))
